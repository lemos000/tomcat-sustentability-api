...
public class RegioesSustentaveisDAO {
    ...
    public boolean inserir(RegiaoSustentavel regiao) throws SQLException {
        String sql = "INSERT INTO PF0645.REGOES_SUSTENTAVEIS (nome) VALUES (?)";
    ...
    public boolean deletar(int id) throws SQLException {
        PreparedStatement stmt = minhaConexao.prepareStatement(
                "DELETE FROM PF0645.REGOES_SUSTENTAVEIS WHERE id_regiao = ?");
        stmt.setInt(1, id);
        stmt.execute();
        stmt.close();
        return true;
    ...
    public String atualizar(RegiaoSustentavel regiao) throws SQLException {
        String sql = "UPDATE PF0645.REGOES_SUSTENTAVEIS SET nome = ? WHERE id_regiao = ?";
    ...
    public RegiaoSustentavel selecionar(int id) throws SQLException {
        PreparedStatement stmt = minhaConexao.prepareStatement(
                "SELECT * FROM PF0645.REGOES_SUSTENTAVEIS WHERE id_regiao = ?");
        stmt.setInt(1, id);
    ...
    public List<RegiaoSustentavel> selecionarTodos() throws SQLException {
        ...
        PreparedStatement stmt = minhaConexao.prepareStatement(
                "SELECT * FROM PF0645.REGOES_SUSTENTAVEIS ORDER BY id_regiao");
        ResultSet rs = stmt.executeQuery();
